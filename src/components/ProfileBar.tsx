...
const ProfileBar = () => {
    ...
    const handleSettingsClick = () => {
        toast.info("Settings are unavailable for now");
    };
            ...
            <div className="flex justify-between items-center rounded-2xl w-full h-full p-0.5 bg-[#D8DEEC]">
                ...
                <div className="flex gap-2">
                    <div className="flex justify-center items-center rounded-full w-15 h-15">
                        <Image
                            src={user?.profilePicture || "/dp.jpeg"}
                            width={50}
                            height={50}
                ...
                <div
                    className="flex justify-center items-center w-10 h-10 rounded-full mr-1 cursor-pointer"
